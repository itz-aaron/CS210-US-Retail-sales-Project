...
import os
import chart_style  # Imports your custom theme!
...
# 3. Query the Macro Data (Total US Retail Economy by Year)
query = """
...
# 4. Generate the Plot
plt.figure()
# We divide by 1,000 to convert Millions to Billions for cleaner axis labels
